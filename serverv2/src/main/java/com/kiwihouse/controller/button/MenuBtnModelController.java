...
public class MenuBtnModelController extends BaseController {
	...
	@ApiOperation(value = "info", notes = "<br>@description: <b>查询页面按钮模板列表</b></br>"
			+ "<br>@Date: <b>2020-3-5 15:45:51</b></br>", httpMethod = "GET")
	...
	@ApiOperation(value = "info", notes = "<br>@description: <b>添加模板按钮</b></br>"
	...
	@ApiOperation(value = "info", notes = "<br>@description: <b>添加或修改模板按钮</b></br>"
			+ "<br>@Date: <b>2020-3-5 16:39:06</b></br>", httpMethod = "POST")
	@ApiResponses(@ApiResponse(code = 0, message = "回调参数：只有code和msg,无具体数据result"))
